...
export default function CardBusiness(props) {
    ...
    return(
            <div className='flex'>
                <Link href={`/BizDetails/${biz?.id}`}>
                    <div className="flex flex-row w-[30rem] cursor-pointer hover:shadow-lg m-8 shadow-md border rounded-md p-3 border-gray-400" id={biz?.id} >
