...
export default function Drawer({ isOpen, toggle }) {
    return (
        <ul className={isOpen ? 'grid grid-rows-3 bg-[#FBED04] text-center items-center content-center transform transition duration-500 ease-in-out' : 'hidden'} onClick={toggle}>
